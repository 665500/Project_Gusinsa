...
<title>Insert title here</title>
            <link rel="stylesheet" href="resources/css/men,women.top.css">
...
<body>
    <table class="guide">
        <tr>
            ...
            <td><a href="./men.outer.html">TOP</a></td>
        </tr>
    </table>
    ...
    <table >
        <tr>
            <td class="category">TOP</td>
        </tr>
    </table>
    <table class="category_bt">
        <tr>
            <td><a href="">Shirts(LS)</a></td>
        </tr>
        <tr>
            <td><a href="">Shirts(1/2)</a></td>
        </tr>
        <tr>
            <td><a href="">Tee(LS)</a></td>
        </tr>
        <tr>
            <td><a href="">Tee(1/2)</a></td>
        </tr>
        <tr>
            <td><a href="">Sleeveless</a></td>
        </tr>
        <tr>
            <td><a href="">Knit</a></td>
        </tr>
     ...
     <table class="t2">
        ...
        <tr>
          <c:forEach items="${womentop }" var="dto" varStatus ="status">
    ...
    <form action="womentop" method="post">
	<c:if test="${searchVO.totPage>1 }"> <!-- 토탈 페이지가 1보다 크면 -->
		<c:if test="${searchVO.page>1 }">
			<a href="womentop?page=1">[처음]</a>
			<a href="womentop?page=${searchVO.page-1 }">[이전]</a>
		</c:if>
	...
	<c:forEach begin="${searchVO.pageStart }" end="${searchVO.pageEnd }" var="i">
		<c:choose>
			<c:when test="${i eq searchVO.page }">  <!-- i eq searchVO.page 내가 클릭한 페이지가 같을 때 -->
			 ...
			 <c:otherwise>
				<a href="womentop?page=${i }" style="text-decoration: none">${i }</a>&nbsp;
			</c:otherwise> 
		
		</c:choose>
	</c:forEach>
		<c:if test="${searchVO.totPage>searchVO.page }"> <!-- 마지막 페이지가 아닐때 -->
			<a href="womentop?page=${searchVO.page+1 }">></a>
			<a href="womentop?page=${searchVO.totPage }">>></a>
		</c:if>
	</c:if>
    </div>
