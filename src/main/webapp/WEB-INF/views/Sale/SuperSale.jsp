...
function cart() {
	...
	// 스페이스바 주의 null값 우려
	location.href ="mypageinsert?p_code=${indto.p_code }"+"&amount="+ amount +"&sell_price="+sum +"&p_price=" +sell_price+"&p_size="+psize; 
...
<!--     
    ...
    <div class="div4" style="position: relative; left: 100px">
        <figure class="fig1">
            <h2 class="h2-1">41%</h2>
            <figcaption class="figcap1"> ${indto.sprice } &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;♡</figcaption> <br>
            <hr class="hr1"> <br>
            ...
            <figcaption class="">
               ...
               <br />
                    ...
                    <tr>
                        ...
                        수량 : <input type=hidden id = "sell_price" name="sell_price" value="${indto.sprice }">
                            </form> 
                            <br>
